...
df1 = np.load("input_granary/xg-temp1030-l1.npy")
df2 = np.load("input_granary/xg-temp1030-l2.npy")
df3 = np.load("input_granary/xg-temp1030-l3.npy")

df4 = np.load("input_granary/xg-hum1030-l1.npy")
df5 = np.load("input_granary/xg-hum1030-l2.npy")
df6 = np.load("input_granary/xg-hum1030-l3.npy")
t_total = 1769
...
Y_t = np.load('input_granary/Y_temp.npy')
B_t = np.load('input_granary/B_mat_temp.npy')

beta_ini_t = np.load('input_granary/beta_temp.npy')
Y_hat_t = B_t@beta_ini_t

Y_h = np.load('input_granary/Y_hum.npy')
B_h = np.load('input_granary/B_mat_hum.npy')# B_h = B_t

beta_ini_h = np.load('input_granary/beta_hum.npy')
