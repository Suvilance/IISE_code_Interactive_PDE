...
psi_11 = np.load('output_temp/psi_1_steady.npy')
psi_12 = np.load('output_temp/psi_2_steady.npy')
psi_13 = np.load('output_temp/psi_3_steady.npy')
psi_21 = np.load('output_hum/psi_1_steady.npy')
psi_22 = np.load('output_hum/psi_2_steady.npy')
psi_23 = np.load('output_hum/psi_3_steady.npy')

B_psi = np.load('input_granary/B_psi_91.npy')
shape_psi = 5
...
plt.tight_layout()
plt.savefig('pic/Time-varying parameters-Temperature-%s-1by1'%(now.strftime('%Y%m%d')), dpi=1200, bbox_inches='tight')
...
plt.legend(ncol=1, fontsize=18, bbox_to_anchor=(0.8, num2), loc=num3, borderaxespad=num4)
plt.tight_layout()
plt.savefig('pic/Time-varying parameters-Humidity-%s-1by1'%(now.strftime('%Y%m%d')), dpi=1200, bbox_inches='tight')