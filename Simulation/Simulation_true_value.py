...
np.save('input_penalty_cut/B_mat_TV_1.npy',BS_model_1.predict_B_2D(tn, xn))
np.save('input_penalty_cut/beta_TV_1.npy',beta_1)
np.save('input_penalty_cut/Y_TV_1.npy',validation_1)

np.save('input_penalty_cut/X_f_TV_1.npy',X_f_1pre)
np.save('input_penalty_cut/T_f_TV_1.npy',T_f_1pre)
np.save('input_penalty_cut/X_d_TV_1.npy',X_d_1pre)
np.save('input_penalty_cut/B_mat_TV_2.npy',BS_model_2.predict_B_2D(tn, xn))
np.save('input_penalty_cut/beta_TV_2.npy',beta_2)
np.save('input_penalty_cut/Y_TV_2.npy',validation_2)

np.save('input_penalty_cut/X_f_TV_2.npy',X_f_2pre)
np.save('input_penalty_cut/T_f_TV_2.npy',T_f_2pre)
np.save('input_penalty_cut/X_d_TV_2.npy',X_d_2pre)
np.save('input_penalty_cut/B_mat_TV_3.npy',BS_model_3.predict_B_2D(tn, xn))
np.save('input_penalty_cut/beta_TV_3.npy',beta_3)
np.save('input_penalty_cut/Y_TV_3.npy',validation_3)

np.save('input_penalty_cut/X_f_TV_3.npy',X_f_3pre)
np.save('input_penalty_cut/T_f_TV_3.npy',T_f_3pre)
np.save('input_penalty_cut/X_d_TV_3.npy',X_d_3pre)
np.save('input_penalty_cut/B_psi.npy',B_theta)
np.save('input_penalty_cut/psi_node.npy',theta_node)
np.save('input_penalty_cut/H11.npy', H11)
np.save('input_penalty_cut/H12.npy', H12)

np.save('input_penalty_cut/H21.npy', H21)
np.save('input_penalty_cut/H22.npy', H22)

np.save('input_penalty_cut/H31.npy', H31)
np.save('input_penalty_cut/H32.npy', H32)